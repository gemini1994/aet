...
ax.broken_barh([(20, 160)], (20, 1), facecolors='K',edgecolor = 'w',label = '471.omnetpp')
ax.broken_barh([(20, 160)], (22, 1), facecolors='y',edgecolor = 'w',label = '470.lbm')
...
ax.set_xticklabels([ '1', '2', '3', '4'],size=20)
plt.xlabel('Cache ways',size = 25)
ax.set_yticklabels([])
...
ax.annotate('Full-share:', (21, 24),fontsize=20)
ax.annotate('Non-overlap:', (21, 18),fontsize=20)
ax.annotate('Overlap:', (21, 12),fontsize=20)
