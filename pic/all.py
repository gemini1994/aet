...
ax_ipc.axis([0,25,4,18])
newax_ipc.axis([0,25,4,18])
ax_ipc.set_xlabel('Percentage of sensitive workload')
...
ax_ws.set_xlabel('Percentage of sensitive workload')
...
ax_ms.set_xlabel('Percentage of sensitive workload')
...
ax_fs.set_xlabel('Percentage of sensitive workload')
